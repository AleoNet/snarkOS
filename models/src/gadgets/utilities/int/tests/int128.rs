use crate::{
    ...
    gadgets::{
        ...
        utilities::{alloc::AllocGadget, arithmetic::*, boolean::Boolean, eq::EqGadget, int::Int128},
    },
};
...
fn test_int128_constant_and_alloc() {
    ...
    for _ in 0..1000 {
        ...
        let a_bit_fe = Int128::alloc_input_fe(cs.ns(|| "a_bit_fe"), a).unwrap();
...
fn test_int128_sub_constants() {
    ...
    for _ in 0..1000 {
        ...
        if b.checked_neg().is_none() {
            // negate with overflows will fail: -170141183460469231731687303715884105728
            continue;
        }
...
fn test_int128_div_constants() {
    ...
    for _ in 0..10 {
        ...
        let a: i128 = rng.gen_range(-i128::MAX, i128::MAX);
        let b: i128 = rng.gen_range(-i128::MAX, i128::MAX);
