mod consensus_sidechain {
    ...
    //    #[test]
    //    fn reject() {
    //        let mut blockchain = FIXTURE_VK.ledger();
    //        let parameters = load_verifying_parameters();
    //
    //        let mut memory_pool = MemoryPool::new();
    //
    //        let consensus = TEST_CONSENSUS;
    //
    //        let block_1_canon = block_1();
    //        let block_1_side = block_1_late();
    //
    //        let old_block_height = blockchain.get_latest_block_height();
    //
    ...
    //
    //        consensus
    //            .receive_block(&parameters, &mut blockchain, &mut memory_pool, &block_1_canon)
    //            .unwrap();
    //
    //        // 2. Receive sidechain block 1.
    //
    //        consensus
    //            .receive_block(&parameters, &mut blockchain, &mut memory_pool, &block_1_side.clone())
    //            .unwrap();
    //
    //        let new_block_height = blockchain.get_latest_block_height();
    //
    ...
    //        let consensus = TEST_CONSENSUS;
    //
    //        let block_1_canon = block_1_late();
    //        let block_1_side = block_1();
    //        let block_2_side = block_2();
    //
    ...
    //
    //        consensus
    //            .receive_block(&parameters, &mut blockchain, &mut memory_pool, &block_1_side)
    //            .unwrap();
    //
    //        consensus
    //            .receive_block(&parameters, &mut blockchain, &mut memory_pool, &block_2_side)
    //            .unwrap();
    //
    ...
    //
    //        let block_1_canon = block_1();
    //        let block_2_canon = block_2();
    //        let block_1_side = block_1_late();
    //        let block_2_side = block_2_late();
    //
    ...
    //
    //        consensus
    //            .receive_block(&parameters, &mut blockchain, &mut memory_pool, &block_2_canon)
    //            .unwrap();
    //
    //        let mut new_block_height = blockchain.get_latest_block_height();
    //
