...
//
//        assert_eq!(
//            rpc.request("getbalance", &[genesis_miner]),
//            format![r#"{}"#, GENESIS_BLOCK_GENESIS_MINER_BALANCE]
//        );
//
//        drop(rpc);
//        kill_storage_async(path);
...
//            format![r#""{}""#, GENESIS_BLOCK_HEADER_HASH]
//        );
//
//        drop(rpc);
//        kill_storage_async(path);
...
//
//        assert_eq!(
//            rpc.request("getrawtransaction", &[GENESIS_TRANSACTION_ID]),
//            format![r#""{}""#, GENESIS_TRANSACTION]
//        );
//
//        drop(rpc);
//        kill_storage_async(path);
...
//
//        assert_eq!(
//            rpc.request("createrawtransaction", &(vec![inputs], outputs)),
//            format![r#""{}""#, TEST_TRANSACTION_UNSIGNED]
//        );
//
//        drop(rpc);
//        kill_storage_async(path);
