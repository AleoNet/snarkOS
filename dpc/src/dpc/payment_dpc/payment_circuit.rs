...
impl<C: PaymentDPCComponents> ToConstraintField<C::InnerField> for PaymentPredicateLocalData<C>
where
...
impl<C: PaymentDPCComponents> ConstraintSynthesizer<C::InnerField> for PaymentCircuit<C> {
...
fn execute_payment_check_gadget<C: PaymentDPCComponents, CS: ConstraintSystem<C::InnerField>>(
    cs: &mut CS,
    comm_and_crh_parameters: &CommAndCRHPublicParameters<C>,
