...
pub struct DPCTransaction<C: BaseDPCComponents> {
    ...
    pub new_records_final_fq_high_selectors: Vec<bool>,
...
impl<C: BaseDPCComponents> DPCTransaction<C> {
    pub fn new(
        ...
        new_records_final_fq_high_selectors: Vec<bool>,
    ) -> Self {
        Self {
            old_serial_numbers,
            new_commitments,
...
impl<C: BaseDPCComponents> ToBytes for DPCTransaction<C> {
    ...
    fn write<W: Write>(&self, mut writer: W) -> IoResult<()> {
        ...
        for (ciphertext, final_fq_high_selector_bit) in self
            .record_ciphertexts
            .iter()
            .zip_eq(&self.new_records_final_fq_high_selectors)
        {
            ...
            ciphertext_selector_bits.push(*final_fq_high_selector_bit);
...
impl<C: BaseDPCComponents> FromBytes for DPCTransaction<C> {
    ...
    fn read<R: Read>(mut reader: R) -> IoResult<Self> {
        ...
        let mut new_records_final_fq_high_selectors = Vec::with_capacity(C::NUM_OUTPUT_RECORDS);
        for _ in 0..num_ciphertexts {
            ...
            new_records_final_fq_high_selectors.push(final_fq_high_selector_bit);
        }
