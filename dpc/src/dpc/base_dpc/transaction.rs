...
pub struct DPCTransaction<C: BaseDPCComponents> {
    ...
    /// Ciphertexts of the new records generated by the transaction
    pub record_ciphertexts: Vec<Vec<(<C::AccountEncryption as EncryptionScheme>::Text, bool)>>,
...
impl<C: BaseDPCComponents> DPCTransaction<C> {
    pub fn new(
        ...
        record_ciphertexts: Vec<Vec<(<C::AccountEncryption as EncryptionScheme>::Text, bool)>>,
    ) -> Self {
        Self {
            old_serial_numbers,
            new_commitments,
...
impl<C: BaseDPCComponents> Transaction for DPCTransaction<C> {
    type Ciphertext = Vec<(<C::AccountEncryption as EncryptionScheme>::Text, bool)>;
...
impl<C: BaseDPCComponents> ToBytes for DPCTransaction<C> {
    ...
    fn write<W: Write>(&self, mut writer: W) -> IoResult<()> {
        ...
        for ciphertext in &self.record_ciphertexts {
            ...
            for (ciphertext_element, fq_high) in ciphertext {
    ...
    fn read<R: Read>(mut reader: R) -> IoResult<Self> {
        ...
        for _ in 0..num_ciphertexts {
            ...
            for _ in 0..num_ciphertext_elements {
                ...
                let fq_high: bool = FromBytes::read(&mut reader)?;
                ciphertext.push((ciphertext_element, fq_high));
            }
