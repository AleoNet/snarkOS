...
pub fn execute_core_checks_gadget<C: PaymentDPCComponents, CS: ConstraintSystem<C::InnerField>>(
    cs: &mut CS,
    // Parameters
...
pub fn execute_proof_check_gadget<C: PaymentDPCComponents, CS: ConstraintSystem<C::OuterField>>(
    cs: &mut CS,
    // Parameters
    comm_crh_parameters: &CommAndCRHPublicParameters<C>,
    ...
    <C::ValueComm as CommitmentScheme>::Parameters: ToConstraintField<C::InnerField>,
{
    ...
    let value_comm_pp_fe =
        ToConstraintField::<C::InnerField>::to_field_elements(comm_crh_parameters.value_comm_pp.parameters())
            .map_err(|_| SynthesisError::AssignmentMissing)?;
