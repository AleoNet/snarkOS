...
pub fn execute_core_checks_gadget<C: PaymentDPCComponents, CS: ConstraintSystem<C::InnerF>>(
    cs: &mut CS,
    // Parameters
...
pub fn execute_proof_check_gadget<C: PaymentDPCComponents, CS: ConstraintSystem<C::OuterF>>(
    cs: &mut CS,
    // Parameters
    comm_crh_parameters: &CommAndCRHPublicParameters<C>,
    ...
    <C::ValueComm as CommitmentScheme>::Parameters: ToConstraintField<C::InnerF>,
{
    ...
    let value_comm_pp_fe =
        ToConstraintField::<C::InnerF>::to_field_elements(comm_crh_parameters.value_comm_pp.parameters())
            .map_err(|_| SynthesisError::AssignmentMissing)?;
