use crate::base_dpc::{BaseDPCComponents, DummyCircuit, LocalData, PrivateProgramInput, ProgramLocalData};
...
pub struct DummyProgram<C: BaseDPCComponents, S: SNARK> {
...
impl<C: BaseDPCComponents, S: SNARK> DummyProgram<C, S> {
...
impl<C: BaseDPCComponents, S: SNARK> Program for DummyProgram<C, S>
where
    S: SNARK<AssignedCircuit = DummyCircuit<C>, VerifierInput = ProgramLocalData<C>>,
{
    ...
    fn execute<R: Rng>(
        ...
        let circuit = DummyCircuit::<C>::new(&local_data, position);
