...
### Example Request
```ignore
curl --data-binary '{"jsonrpc": "2.0", "id":"documentation", "method": "gettransition", "params": ["as1v7dvwcwy8430kvt74chprep904mvw4wmy3svll4tlt7vqpgutspsf79ek0"] }' -H 'content-type: application/json' http://127.0.0.1:3030/
```
