...
pub(crate) enum BlockRequestHandler {
    ...
    Proceed(BlockRequestHandlerProceed),
}
...
pub(crate) fn handle_block_requests<N: Network, E: Environment>(
    ...
    BlockRequestHandler::Proceed(BlockRequestHandlerProceed {
        start_block_height,
        end_block_height,
        ledger_is_on_fork,
    })
...
mod tests {
    ...
    async fn test_block_requests_case_1() {
        ...
        for _ in 0..ITERATIONS {
            ...
            // Validate the output.
            assert_eq!(result, BlockRequestHandler::Abort);
        }
    }
    ...
    async fn test_block_requests_case_2cba() {
        ...
        for _ in 0..ITERATIONS {
            ...
            // Validate the output.
            assert_eq!(result, BlockRequestHandler::AbortAndDisconnect("exceeded fork range".into()));
        }
    }
