...
/// The maximum number of seconds allowed for even round advancement. 
pub const MAX_EVEN_ROUND_DELAY_IN_SECS: i64 = 4 * MAX_BATCH_DELAY_IN_MS as i64 / 1000; // seconds
