...
impl<N: Network> Storage<N> {
    ...
    pub fn check_batch_header(
        ...
        if !previous_committee_with_lag.is_committee_member(batch_header.author()) {
        ...
        if previous_round > gc_round {
            ...
            if batch_header.previous_certificate_ids().len() > previous_committee_with_lag.num_members() {
            ...
            if !previous_committee_with_lag.is_quorum_threshold_reached(&previous_authors) {
    ...
    pub fn check_certificate(
        ...
        for signature in certificate.signatures() {
            ...
            if !previous_committee_with_lag.is_committee_member(signer) {
        ...
        if !previous_committee_with_lag.is_quorum_threshold_reached(&signers) {
