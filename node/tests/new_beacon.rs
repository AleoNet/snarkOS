...
async fn handshake_responder_side() {
    ...
    // 2. Spin up test peer.
    // 3. Connect the peer to the beacon, assert on handshake.
}

use snarkos_node::new_beacon::{Beacon, PeerMeta};
...
use snarkvm::prelude::{Block, ConsensusMemory, FromBytes, Network, PrivateKey, Testnet3 as CurrentNetwork};
