...
use crate::bls12_377::{
    g1::Bls12_377G1Parameters, Bls12_377, Fq, Fq12, Fq2, Fq2Parameters, Fq6, Fq6Parameters, FqParameters, Fr, G1Affine,
...
use snarkos_models::curves::{
    ...
    AffineCurve, Field, Fp2Parameters, FpParameters,
    LegendreSymbol::*,
    PairingEngine, PrimeField, ProjectiveCurve, SWModelParameters, SquareRootField,
};
