        ...
        match self {
            Self::New { network, seed, vanity, discreet } => {
                ...
                match vanity {
                    ...
                    Some(vanity) => match network {
                        ...
                        TestnetV1::ID => Self::new_vanity::<TestnetV1>(vanity.as_str(), discreet),
                    ...
                    None => match network {
                        ...
                        TestnetV1::ID => Self::new_seeded::<TestnetV1>(seed, discreet),
                        unknown_id => bail!("Unknown network ID ({unknown_id})"),
                    },
                }
            }
            Self::Sign { network, message, seed, raw, private_key, private_key_file } => {
                ...
                match network {
                    ...
                    TestnetV1::ID => Self::sign::<TestnetV1>(key, message, seed, raw),
                    unknown_id => bail!("Unknown network ID ({unknown_id})"),
                }
            }
            Self::Verify { network, address, signature, message, raw } => {
                ...
                match network {
                    ...
                    TestnetV1::ID => Self::verify::<TestnetV1>(address, signature, message, raw),
                    unknown_id => bail!("Unknown network ID ({unknown_id})"),
                }
            }
        }
